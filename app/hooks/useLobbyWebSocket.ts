...
export const useLobbyWebSocket = ({
  ...
  // Subscribe to lobby updates (general and user-specific)
  ...
  }, [token, onError, lobbyCode, subscribeLobby, subscribeToInviteResults]);
  ...
  const updateLobby = useCallback(
    (settings: { maxPlayers?: number; playersPerTeam?: number }) => {
